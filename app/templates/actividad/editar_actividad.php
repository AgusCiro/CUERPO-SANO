...
// Errores y datos de la actividad vienen del controlador
$errores = $errores ?? [];
$actividad = $actividad ?? []; // Asegura que $actividad exista
?>
...
<head>
    ...
    <title>Editar Actividad - Cuerpo Sano</title>
    ...
    <div class="dashboard-container">
        ...
        <main class="main-content">
            ...
            <section class="content">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Actualiza los datos de la actividad</h5>
                                ...
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" id="intensidad" name="intensidad">
                                            ...
                                            <option value="Alta" <?php echo ($actividad['intensidad'] ?? '') === 'Alta' ? 'selected' : ''; ?>>Alta</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
