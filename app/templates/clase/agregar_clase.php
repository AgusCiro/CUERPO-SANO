...
<head>
    ...
    <title>Nueva Clase - Cuerpo Sano</title>
        ...
        <main class="main-content">
            <header>
                <div class="header-content">
                    <h1><i class="fas fa-plus"></i> Nueva Clase</h1>
            ...
            <section class="content">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Completa los datos de la clase</h5>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select" id="entrenador_id" name="entrenador_id" required>
                                            ...
                                            <?php foreach ($entrenadores as $entrenador): ?>
                                                <option value="<?php echo $entrenador['id']; ?>"><?php echo htmlspecialchars($entrenador['nombre'] . ' ' . $entrenador['apellido']); ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                    </div>
                                </div>
